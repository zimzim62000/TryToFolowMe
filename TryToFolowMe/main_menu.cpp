...
void main_menu::Initialize(sf::RenderWindow* window)
{
	...
	this->title = new sf::Text("Try to Folow Me", *this->font, 200U);
...
void main_menu::Update(float const dt, sf::RenderWindow* window)
{
...
void main_menu::Render(float const dt, sf::RenderWindow* window)
{
