...
public:
	...
	void ajouter_cases_adjacentes(std::pair <int, int>& n, sf::RenderWindow* window, MyMap* map);
	void findRoad(MyMap* map, sf::RenderWindow* window, const int start_x, const int start_y, const int end_x, const int end_y);
